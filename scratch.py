...
power_five = Cluster(schedule=schedule, teams=[x for x in schedule if schedule[x]['conference'] in pfive + ['fbs independent']])
group_of_five = Cluster(schedule=schedule, teams=[x for x in schedule if schedule[x]['conference'] in pfive + ['fbs independent']])
'''
